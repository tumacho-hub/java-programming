...
public class StringContacPractice {
    public static void main(String[] args) {
        //we want java 8 it wont work becvause java works from left to right!
        System.out.println("java " + 5 + 3 );
        // we want java  to add the number so we need two parenthesis ex
        System.out.println("java" + (5 + 3));
